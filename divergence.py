...
def divergence_function(**kwargs):
    if kwargs["divergence"] == "kl":
        return kullback_leibler_gaussians(kwargs["mean"], kwargs["log_variance"])
    elif kwargs["divergence"] == "mmd":
        return maximum_mean_discrepancy(kwargs["z"], kwargs["z_prior"])
    elif kwargs["divergence"] == "swd":
        return sliced_wasserstein_distance(kwargs["z"], kwargs["z_prior"])
    else:
